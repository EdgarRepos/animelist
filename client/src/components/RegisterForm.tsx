  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="mb-3">
        ...
        <input className="form-control" disabled={isRegisterValid} onChange={handleChange} id="emailInput" name="email" placeholder="user@mail.com" type="email" value={values.email} />
      </div>

      <div className="mb-2">
        <label className="form-label" htmlFor="usernameInput">Username</label>
        <input className="form-control" disabled={isRegisterValid} onChange={handleChange} id="usernameInput" name="username" type="text" value={values.username} />
        <span className="badge text-dark">Between 3 and 10 characters</span>
      </div>

      <div className="mb-3">
        <label className="form-label" htmlFor="passwordInput">Password</label>
        <input className="form-control" disabled={isRegisterValid} onChange={handleChange} id="passwordInput" name="password" type="password" value={values.password}/>
