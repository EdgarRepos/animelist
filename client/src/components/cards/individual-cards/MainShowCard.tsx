      ...
      <div className="card-footer">
        <div className="row">
          ...
          <div className="col-6 text-center">
            <button className={!showForm ? "btn btn-primary mb-0" : "btn btn-danger mb-0"} onClick={handleClick} style={{fontSize: "12px"}} type="button">{!showForm ? "Add to watchlist" : "Cancel"}</button>
          </div>
